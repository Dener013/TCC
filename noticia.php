...
// -------------------------Puxa a noticia que o user escolheu------------------------------------- //


if ($noticia == 2) {
  echo "<script>location.href='quem-somos.html'</script>";
}

$sql = "select *,date_format(dt_noticia, '%d-%m-%Y') as 'dt_noticia' from tb_noticia where cd_noticia = '$noticia';";
...
if ($log == true) {
  ...
  echo " <a class='navbar-brand' id='logo' href='home.php'><img id='logo' class='img-responsive' src='img/logo-azul.png'></a>"; 

}else{

  echo " <a class='navbar-brand' id='logo' href='index.php'><img id='logo' class='img-responsive' src='img/logo-azul.png'></a>"; 
...
<div class="container" id="noticia-box"> 
    <h2 id="manchete-not"><?php echo "$manchete"; ?></h2>
    <img id="img-noticia" <?php echo "src='$image'"; ?>>
      <div id="txt-panel" class="panel panel-default">
         <div class="panel-heading" id="info-noticia" align="right"><?php echo "$autor $data"; ?></div>
          <div class="panel-body" align="justify" id="noticia-txt"><?php echo "$texto"; ?></div>
      </div>
</div>
